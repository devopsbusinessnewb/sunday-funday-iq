...
if(!html.includes('Build 1.4.0')) throw new Error('Expected Pickem Build 1.4.0');
...
if(!html.includes('id="phoneSyncBtn"')||!html.includes("$('phoneSyncBtn').onclick=pasteCbsPhoneSync"))throw new Error('iPhone CBS sync control missing');
