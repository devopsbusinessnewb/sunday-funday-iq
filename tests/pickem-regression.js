...
if(!html.includes('Build 1.4.4')) throw new Error('Expected Pickem Build 1.4.2');
...
const protectedGames=clone(postGames);protectedGames[2].protected=true;
const protectedRun=t.runOptimizer(protectedGames,93,{...stableOpts,searchIters:60,finalIters:120});
if(protectedRun.recommended.choices[2]!==stableOpts.currentCard.choices[2]||protectedRun.recommended.weights[2]!==stableOpts.currentCard.weights[2])throw new Error('protected card changed');
